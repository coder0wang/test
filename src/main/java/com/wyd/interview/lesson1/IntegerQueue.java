package com.wyd.interview.lesson1;
...
class Queue // 队列类
{
	...
	// --------------------------------------------------------------
	public long front() // 取得队列的队头元素。该运算与 remove()不同，后者要修改队头元素指针。
	{
...
public class IntegerQueue {
	public static void main(String[] args) {
		...
		theQueue.push(10); // 添加4个元素
		theQueue.push(20);
		theQueue.push(30);
		theQueue.push(40);

		theQueue.pop(); // 移除3个元素
		theQueue.pop(); // (10, 20, 30)
		theQueue.pop();

		theQueue.push(50); // 添加4个元素
		theQueue.push(60);
		theQueue.push(70);
		theQueue.push(80);
