package com.coder.test.dingcan;
...
public class HttpClientDemo
{
    ...
    private static void getResoucesByLoginCookies() throws Exception
    {
        ...
        String username = "王愉迪";// 登录用户
        String password = "111111";// 登录密码
 
        String urlLogin = "http://dingcan.kaikeba.com/login/?username='"+username+"'&password='"+password+"'";
 
        String urlAfter = "http://dingcan.kaikeba.com/index/";
        ...
        String pathName = "/Users/wangyudi/work/kaike/myindex.html";
